            		...
            		<div class="col-span-2 p-5">
            			...
            			<div class="flex justify-between items-center mt-6 pt-6">
            				<div class="flex  items-center">
            					<img src="/img/neckalace.jpg" width="60" class="rounded-full ">

            					<div class="flex flex-col ml-3">
            						<span class="md:text-md font-medium">Key Necklace</span>
            			...
            			<div class="flex justify-between items-center pt-6 mt-6 border-t">
            				<div class="flex  items-center">
            					...
            					<div class="flex flex-col ml-3 ">
            						<span class="text-md font-medium w-auto">Cover Case</span>
            			...
            			<div class="flex justify-between items-center mt-6 pt-6 border-t">
            				<div class="flex  items-center">
            					<img src="/img/tshirt.jpg" alt="tshirt" width="60" class="rounded-full ">

            					<div class="flex flex-col ml-3 ">
            						<span class="text-md font-medium">T shirt</span>
