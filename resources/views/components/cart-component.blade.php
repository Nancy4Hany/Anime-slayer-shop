                    ...
                    <div class="col-12">
                        <div class="table-responsive">
                            <table class="table shopping-summery text-center clean">
                                ...
                                <tbody>
                                    <tr>
                                        <td class="image product-thumbnail"><img src="{{assets('assets/imgs/shop/product-1-2.jpg')}}" alt="#"></td>
                                    ...
                                    <tr>
                                        <td class="image"><img src="{{assets('assets/imgs/shop/product-1-2.jpg')}}" alt="#"></td>
